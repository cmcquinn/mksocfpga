...
machinekit.io:user:hm2_io_ts:1\
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ClockHigh {100000000} \
   CONFIG.ClockLow {50000000} \
   CONFIG.ClockMed {50000000} \
   CONFIG.IOWidth {36} \
   CONFIG.PortWidth {18} \
 ] $HostMot2_ip_wrap_0
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins HostMot2_ip_wrap_0/clkhigh] [get_bd_pins clk_wiz_0/clk_out1]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hm2_axilite_int_0/S_AXI/reg0] SEG_hm2_axilite_int_0_reg0
