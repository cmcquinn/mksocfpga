...
#
# snickerdoodle_7z020.tcl: Tcl script for re-creating project 'snickerdoodle_7z020'
#
# Generated by Vivado on Wed Aug 23 12:02:33 PDT 2017
...
#
# 1. This project restoration tcl script (snickerdoodle_7z020.tcl) that was generated.
#
...
#
#    "/home/cameron/Code/mksocfpga/HW/VivadoProjects/snickerdoodle/replicookie/snickerdoodle_7z020_created/src/soc_system/soc_system.bd"
#    "/home/cameron/Code/mksocfpga/HW/VivadoProjects/snickerdoodle/replicookie/snickerdoodle_7z020_created/src/soc_system/hdl/soc_system_wrapper.vhd"
#    "/home/cameron/Code/mksocfpga/HW/VivadoProjects/snickerdoodle/replicookie/snickerdoodle_7z020_created/firmware_id.mif"
#    "/home/cameron/Code/mksocfpga/HW/VivadoProjects/snickerdoodle/replicookie/const/snickerdoodle_pinmap.xdc"
#
#*****************************************************************************************
...
set script_file "snickerdoodle_7z020.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../snickerdoodle_7z020_created"]"

# Create project
create_project snickerdoodle_7z020 ./snickerdoodle_7z020 -part xc7z020clg400-3
...
set obj [get_projects snickerdoodle_7z020]
...
set_property -name "compxlib.activehdl_compiled_library_dir" -value "$proj_dir/snickerdoodle_7z020.cache/compile_simlib/activehdl" -objects $obj
set_property -name "compxlib.funcsim" -value "1" -objects $obj
set_property -name "compxlib.ies_compiled_library_dir" -value "$proj_dir/snickerdoodle_7z020.cache/compile_simlib/ies" -objects $obj
set_property -name "compxlib.modelsim_compiled_library_dir" -value "$proj_dir/snickerdoodle_7z020.cache/compile_simlib/modelsim" -objects $obj
set_property -name "compxlib.overwrite_libs" -value "0" -objects $obj
set_property -name "compxlib.questa_compiled_library_dir" -value "$proj_dir/snickerdoodle_7z020.cache/compile_simlib/questa" -objects $obj
set_property -name "compxlib.riviera_compiled_library_dir" -value "$proj_dir/snickerdoodle_7z020.cache/compile_simlib/riviera" -objects $obj
set_property -name "compxlib.timesim" -value "1" -objects $obj
set_property -name "compxlib.vcs_compiled_library_dir" -value "$proj_dir/snickerdoodle_7z020.cache/compile_simlib/vcs" -objects $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/../snickerdoodle_7z020_created/src/soc_system/soc_system.bd"]"\
 "[file normalize "$origin_dir/../snickerdoodle_7z020_created/src/soc_system/hdl/soc_system_wrapper.vhd"]"\
 "[file normalize "$origin_dir/../snickerdoodle_7z020_created/firmware_id.mif"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../snickerdoodle_7z020_created/src/soc_system/soc_system.bd"
...
set file "$origin_dir/../snickerdoodle_7z020_created/src/soc_system/hdl/soc_system_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/../snickerdoodle_7z020_created/firmware_id.mif"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property -name "top" -value "soc_system_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../const/snickerdoodle_pinmap.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../const/snickerdoodle_pinmap.xdc"
set file [file normalize $file]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7z020clg400-3 -flow {Vivado Synthesis 2015} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7z020clg400-3 -flow {Vivado Implementation 2015} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
...
puts "INFO: Project created:snickerdoodle_7z020"
